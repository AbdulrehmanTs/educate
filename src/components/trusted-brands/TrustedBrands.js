  ...
  return (
    <section className={`py-[40px] overflow-hidden  ${bgGray ? "bg-gray" : ""} ${bgWhite ? "bg-white" : ""}`}>
      <div className="container h-[100%]">
        ...
        <div className="w-[90%] mx-auto overflow-hidde n">
        <div className="w-[100%] flex gap-x-[0] slide-for-trusted pt-[60px] pb-[50px]">
            <div className="lg:w-[20% ] min-w-[220px]"><img src={Brand5} alt="" /></div>
            <div className="lg:w-[20% ] min-w-[220px]"><img src={Brand4} alt="" /></div>
            <div className="lg:w-[20% ] min-w-[220px]"><img src={Brand3} alt="" /></div>
            <div className="lg:w-[20% ] min-w-[220px]"><img src={Brand2} alt="" /></div>
            <div className="lg:w-[20% ] min-w-[220px]"><img src={Brand1} alt="" /></div>
