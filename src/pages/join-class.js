                ...
                <div className="container">
                    <div className="w-[100%] mt-[30px]">
                        <div className="max-w-[600px] mx-auto relative">
                            ...
                            <div className="mb-[15px] relative"><TextField type="text" id="outlined-basic" helperText="ID Shared by your teacher" label="Enter Classroom ID" variant="outlined" className="w-[100%]" value={classRoomId} onChange={(e) => set_classRoomId(e.target.value)} /> <span className="absolute bottom-0 right-[10px] text-[14px] text-[#6200ff] ">10/10</span></div>
                            <div>
                                <Button variant="contained" fullWidth={true} onClick={() => joinClass()}>
